...
- Keep the Plugins optimization selectable when a complete historical header lacks a Plugins block but the effective Plugins setting is still on; report that case as zero-savings evidence instead of treating it as disabled.
