...
export function platformLabel(value: string): string { return ({ claude: 'Claude', cursor: 'Cursor', copilot: 'Copilot', codex: 'Codex', gemini: 'Gemini', windsurf: 'Windsurf', opencode: 'OpenCode', openclaw: 'OpenClaw', kiro: 'Kiro', trae: 'Trae', hermes: 'Hermes', workbuddy: 'WorkBuddy' } as Record<string, string>)[value] ?? value; }
