...
export const previewOptimizationChange = (projectDir: string, sessionId: string, targets: OptimizationTarget | OptimizationTarget[]): Promise<OptimizationPreview> => request('/api/optimization', { method: 'POST', body: JSON.stringify({ action: 'preview', projectDir, sessionId, targets: Array.isArray(targets) ? targets : [targets] }) });
export const applyOptimizationChange = (projectDir: string, sessionId: string, preview: OptimizationPreview): Promise<OptimizationOperation> => request('/api/optimization', { method: 'POST', body: JSON.stringify({ action: 'apply', projectDir, sessionId, targets: preview.targets, confirmation: preview.confirmation }) });
...
export const undoOptimizationChange = (projectDir: string, operationId: string): Promise<OptimizationOperation> => request('/api/optimization', { method: 'POST', body: JSON.stringify({ action: 'undo', projectDir, operationId, confirmation: operationId }) });
