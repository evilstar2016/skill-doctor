...
describe('groupSkills', () => {
  ...
  it('leaves unrelated skills in ungrouped', () => {
  ...
  it('sorts groups by descending size', () => {
    ...
    const result = groupSkills([a, b, c]);
